package controller.rpc.socketrpc.client;
...
public class RpcClientProxy<T> implements InvocationHandler {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        IDAOAdapter hello = (IDAOAdapter) client.getClientIntance ();
        PIMCollection e = hello.getAll ();
        for (PIMEntity tt:e){
            System.out.println(tt.toDescription());
        }
        System.out.println ();
    }
}